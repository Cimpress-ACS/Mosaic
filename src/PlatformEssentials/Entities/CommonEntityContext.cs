...
{
    public class CommonEntityContext : DbContext, IEntityContext
    {
        private readonly ILogger _logger;

        public CommonEntityContext(string connectionString, ILogger logger)
            : base(connectionString)
        {
            ...
            // it is crucial because of delayed execution. Don't forget to use ChangeTracker.DetectChanges() before SaveChanges()
        ...
        public virtual DbSet<PlatformItem> PlatformItems { get; set; }

        public virtual DbSet<PlatformModuleEntity> PlatformModuleEntities { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            .HasMany(e => e.JobItems);

            modelBuilder.Entity<PlatformItem>()
                .HasKey(e => e.Id);

            modelBuilder.Entity<PlatformItem>()
                .HasOptional(e => e.ItemInFront)
                .WithMany();

            modelBuilder.Entity<PlatformItem>()
                .HasOptional(e => e.ItemBehind)
                .WithMany();

            modelBuilder.Entity<PlatformItem>()
                .HasOptional(e => e.Route);

            modelBuilder.Entity<PlatformModuleEntity>()
                .HasMany(e => e.PlatformItems)
                .WithOptional(e => e.AssociatedPlatformModuleEntity);

            modelBuilder.Entity<RouteItem>()
                .HasMany(e => e.ProcessData);

            modelBuilder.Entity<RouteItem>()
                .HasMany(e => e.ProcessSettings);

            modelBuilder.Entity<Route>()
                .HasMany(e => e.RouteItems);
        }
